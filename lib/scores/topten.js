            ...
            .then(function(gameInfo) {
                ...
                .then(function (data) {
                    ...
                    for (var i = 0; i < homeStats.length + awayStats.length; i++) {
                    	...
                    	playerStats.name = doc.getElementsByTagName("name")[0].childNodes[0].nodeValue;
                    	...
                    	playerStats.disposals = parseInt(doc.getElementsByTagName("kick")[i].nodeValue) + parseInt(doc.getElementsByTagName("handball")[i].nodeValue);
                    	playerStats.goals = parseInt(doc.getElementsByTagName("goal")[i].nodeValue);
                    	playerStats.behinds = parseInt(doc.getElementsByTagName("behind")[i].nodeValue);
                    	playerStats.dt = parseInt(doc.getElementsByTagName("dt")[i].nodeValue);
