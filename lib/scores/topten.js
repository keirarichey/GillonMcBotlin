            ...
            .then(function(gameInfo) {
                ...
                .then(function (data) {
                    ...
                    for (var i = 0; i < homeStats.getElementsByTagName("player").length; i++) {
                    	...
                    	playerStats.disposals = parseInt(homeStats.getElementsByTagName("player")[i].getElementsByTagName("kick")[0].nodeValue) + parseInt(homeStats.getElementsByTagName("player")[i].getElementsByTagName("handball")[0].nodeValue);
                    	playerStats.goals = parseInt(homeStats.getElementsByTagName("player")[i].getElementsByTagName("goal")[0].nodeValue);
                    	playerStats.behinds = parseInt(homeStats.getElementsByTagName("player")[i].getElementsByTagName("behind")[0].nodeValue);
                    	playerStats.dt = parseInt(homeStats.getElementsByTagName("player")[i].getElementsByTagName("dt")[0].nodeValue);
                    ...
                    for (var i = 0; i < awayStats.getElementsByTagName("player").length; i++) {
                    	...
                    	playerStats.disposals = parseInt(awayStats.getElementsByTagName("player")[i].getElementsByTagName("kick")[0].nodeValue) + parseInt(awayStats.getElementsByTagName("player")[i].getElementsByTagName("handball")[0].nodeValue);
                    	playerStats.goals = parseInt(awayStats.getElementsByTagName("player")[i].getElementsByTagName("goal")[0].nodeValue);
                    	playerStats.behinds = parseInt(awayStats.getElementsByTagName("player")[i].getElementsByTagName("behind")[0].nodeValue);
                    	playerStats.dt = parseInt(awayStats.getElementsByTagName("player")[i].getElementsByTagName("dt")[0].nodeValue);
