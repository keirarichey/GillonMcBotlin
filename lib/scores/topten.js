        ...
        var getTopTen = (team) => {
        	...
        	.then(function (statsArray) {
        		...
        		for (var i = 0; i < topTen.length; i++) {
        			...
        			var embedLine = `**(${teamEmotes[topTen[i].team]} #${topTen[i].number}) ${topTen[i].name}**\n`
        			embedLine += `${topTen[i].dt} DT Points | ${topTen[i].disposals} Disposals | ${topTen[i].mark} Marks | ${topTen[i].tackle} Tackles | ${topTen[i].togperc} %TOG\n`
