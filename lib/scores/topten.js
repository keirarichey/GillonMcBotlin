            ...
            .then(function(gameInfo) {
                ...
                .then(function (data) {
                    ...
                    for (var i = 0; i < homeStats.getElementsByTagName("player").length; i++) {
                    	...
                    	playerStats.id = parseInt(homeStats.getElementsByTagName("player")[i].getElementsByTagName("playerid")[i].childNodes[0].nodeValue);
                    	...
                    	playerStats.number = parseInt(homeStats.getElementsByTagName("player")[i].getElementsByTagName("jumpernumber")[i].childNodes[0].nodeValue);
                    	playerStats.disposals = parseInt(homeStats.getElementsByTagName("player")[i].getElementsByTagName("kick")[i].nodeValue) + parseInt(homeStats.getElementsByTagName("player")[i].getElementsByTagName("handball")[i].nodeValue);
                    	playerStats.goals = parseInt(homeStats.getElementsByTagName("player")[i].getElementsByTagName("goal")[i].nodeValue);
                    	playerStats.behinds = parseInt(homeStats.getElementsByTagName("player")[i].getElementsByTagName("behind")[i].nodeValue);
                    	playerStats.dt = parseInt(homeStats.getElementsByTagName("player")[i].getElementsByTagName("dt")[i].nodeValue);
                    ...
                    for (var i = 0; i < awayStats.getElementsByTagName("player").length; i++) {
                    	...
                    	playerStats.id = parseInt(awayStats.getElementsByTagName("player")[i].getElementsByTagName("playerid")[i].childNodes[0].nodeValue);
                    	...
                    	playerStats.number = parseInt(awayStats.getElementsByTagName("player")[i].getElementsByTagName("jumpernumber")[i].childNodes[0].nodeValue);
                    	playerStats.disposals = parseInt(awayStats.getElementsByTagName("player")[i].getElementsByTagName("kick")[i].nodeValue) + parseInt(awayStats.getElementsByTagName("player")[i].getElementsByTagName("handball")[i].nodeValue);
                    	playerStats.goals = parseInt(awayStats.getElementsByTagName("player")[i].getElementsByTagName("goal")[i].nodeValue);
                    	playerStats.behinds = parseInt(awayStats.getElementsByTagName("player")[i].getElementsByTagName("behind")[i].nodeValue);
                    	playerStats.dt = parseInt(awayStats.getElementsByTagName("player")[i].getElementsByTagName("dt")[i].nodeValue);
