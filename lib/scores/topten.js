        ...
        var getStats = (team) => {
            ...
            .then(function(gameInfo) {
                ...
                .then(function (data) {
                    ...
                    console.log(doc.getElementsByTagName("playerid"));
                    ...
                    for (var i = 0; i < homeStats.length + awayStats.length; i++) {
                    	...
                    	playerStats.disposals = 1;//parseInt(doc.getElementsByTagName("kick")[i].childNodes[0].nodeValue) + parseInt(doc.getElementsByTagName("handball")[i].childNodes[0].nodeValue);
