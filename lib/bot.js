...
bot.on("message", msg => {
    var bot_channel = msg.guild.channels.get("253192230200803328"); //bot_spam
    var match_fta = msg.guild.channels.get("193362778646511617"); //match_discussion_fta
    var match_fox = msg.guild.channels.get("250245406657740801"); //match_discussion_fox
...
bot.on("guildMemberAdd", member => {
    ...
    var welcomeChannel = server.channels.get("295589980733046784");
