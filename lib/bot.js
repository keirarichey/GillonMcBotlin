...
const welcome_channel = SERVER.channels.find("id", "295589980733046784");
const off_topic_channel = SERVER.channels.find("id", "193359073431912449");
...
bot.on("guildMemberAdd", member => {
    bot.sendWelcome(`<:white_check_mark:364924816261906432> <@${member.id}>, Welcome to r/AFL! Everything Australian Football, now on Discord! To access the main channels, you'll need to provide us a link to your reddit profile or your reddit name.`, "success", welcome_channel);
    bot.sendWelcome(`<:white_check_mark:364924816261906432> <@${member.id}>, Welcome to r/AFL! Everything Australian Football, now on Discord! To access the main channels, you'll need to provide us a link to your reddit profile or your reddit name.`, "success", off_topic_channel);
});

bot.on("guildMemberRemove", member => {
    bot.sendWelcome(`<:x:364941928070119424> **${member.displayName}** just retired from **r/AFL**. Please celebrate as we chair **${member.displayName}** off.`, "error", welcome_channel);
    bot.sendWelcome(`<:x:364941928070119424> **${member.displayName}** just retired from **r/AFL**. Please celebrate as we chair **${member.displayName}** off.`, "error", off_topic_channel);
});
