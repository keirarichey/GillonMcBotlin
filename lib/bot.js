...
bot.on("guildMemberAdd", member => {
    ...
    bot.sendWelcome(`<:white_check_mark:364924816261906432> **${member.displayName}**, Welcome to r/AFL! Everything Australian Football, now on Discord! To access the main channels, you'll need to provide us a link to your reddit profile or your reddit name.`, "success", welcome_channel);
    bot.sendWelcome(`<:white_check_mark:364924816261906432> **${member.displayName}**, Welcome to r/AFL! Everything Australian Football, now on Discord!`, "success", off_topic_channel);
});
