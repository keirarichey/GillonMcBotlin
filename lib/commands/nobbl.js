...
module.exports = {
	...
	execute: (msg, args) => {
		...
		var nobblText = `<:no_entry_sign:364917720212439041> <:cricket:380975256648810496> <@${user.id}> is no longer a fan of any BBL team!`;
		formatMessage.sendNotification(nobblText, "success", msg);
	}
}